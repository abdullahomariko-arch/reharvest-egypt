...
const AR: Dict = {
  ...
  'signin.title': 'أهلًا بك في ريهارفست',
  'signin.lede': 'المنصة بالدعوة فقط. سجّل برقم الموبايل المسجّل عندنا.',
  'signin.phone': 'رقم الموبايل',
  'signin.phoneHint': 'نفس الرقم اللي اتسجل وقت الاعتماد.',
  'signin.cta': 'ابعت كود الدخول',
  'signin.foot': 'مفيش تسجيل ذاتي. لو رقمك مش متسجل، كلّم فريق ريهارفست.',
  'signin.unknown.msg': 'الرقم ده مش مسجّل عندنا.',
  'signin.unknown.fix': 'اتأكد من الرقم، أو كلّم فريق ريهارفست عشان يضيفك.',
  'signin.code': 'كود الدخول',
  'signin.codeHint': 'بعتنا كود من ٦ أرقام على {phone}. صالح لمدة ١٠ دقايق.',
  'signin.verify': 'تأكيد الكود',
  'signin.changeNumber': 'غيّر الرقم',
  'signin.badCode': 'الكود ده مش صحيح أو انتهت صلاحيته.',
  'signin.badPhone': 'الرقم مش مكتوب صح.',
  'signin.rateLimited': 'طلبت كود مرات كتير. استنى شوية وحاول تاني.',
  'signin.retry': 'اطلب كود جديد وحاول تاني.',

  'err.offline': 'مفيش اتصال بالشبكة دلوقتي.',
  'err.load': 'تعذّر تحميل البيانات.',
  'err.retry': 'حاول تاني',
  'err.noLot': 'اختر شحنة الأول من القائمة.',
  'err.noOrder': 'مفيش طلب مفتوح دلوقتي.',
  'ops.alert.FROZEN': 'شحنة موقوفة تحتاج مراجعة',
  'ops.alert.WINDOW_CLOSING': 'مهلة استلام بتنتهي النهاردة',
  'payout.financeManager': 'مدير مالي',

  'weigh.gross': 'الوزن القائم بالكيلو',
  'weigh.grossHint': 'اقرأ الرقم من الميزان كما هو، دون تقريب.',
  'weigh.containers': 'عدد الصناديق',
  'weigh.containersHint': 'عُدّ الصناديق الفارغة بنفسك، متعتمدش على الورقة.',
  'weigh.net': 'الوزن الصافي',
  'weigh.netIdle': 'أدخل الوزن القائم وعدد الصناديق.',
  'weigh.netOk': 'ده الرقم اللي المورّد والمشتري هيتحاسبوا عليه.',
  'weigh.cannotRead': 'لا يمكن اعتماد قراءة',
  'weigh.tare': 'وزن الفارغ',
  'weigh.expected': 'الوزن المتوقع',
  'weigh.difference': 'الفرق',
  'weigh.lineTotal': 'قيمة المستلم',
  'weigh.cta': 'سجّل الوزن واستلم',
  'weigh.recordedCta': 'تم التسجيل ✓',
  'weigh.recordedPill': 'مستلمة',
  'weigh.calibration': 'ميزان {id} · المعايرة سارية حتى {d}',
  'weigh.noScale': 'لا يوجد ميزان معتمد مربوط بالجلسة دي.',
  'weigh.short.msg': 'الوزن المستلم أقل من المطلوب بأكثر من ٥٪.',
  'weigh.short.fix': 'صوّر الشحنة على الميزان، وبلّغ المشتري قبل الاستلام. الحساب هيتم على الرقم ده مش على المطلوب.',
  'block.QTY_UNVERIFIED_SETTLEMENT_WEIGHT': 'الوزن ده مش جاي من ميزان معتمد.',
  'block.QTY_UNVERIFIED_SETTLEMENT_WEIGHT.fix': 'استخدم ميزان المحطة المعتمد. الوزن التقديري أو المُعلن ما ينفعش للمحاسبة.',
  'block.QTY_SCALE_CALIBRATION_EXPIRED': 'معايرة الميزان منتهية.',
  'block.QTY_SCALE_CALIBRATION_EXPIRED.fix': 'عاير الميزان قبل ما تستلم. ميزان بينحرف ٢٪ معناه ١٦ كجم غلط في كل ٨٠٠ كجم.',
};
...
const EN: Dict = {
  ...
  'signin.title': 'Welcome to ReHarvest',
  'signin.lede': 'The platform is invite only. Sign in with the mobile number we have on file.',
  'signin.phone': 'Mobile number',
  'signin.phoneHint': 'The same number registered when you were approved.',
  'signin.cta': 'Send sign-in code',
  'signin.foot': 'There is no self sign-up. If your number is not registered, contact the ReHarvest team.',
  'signin.unknown.msg': 'That number is not registered with us.',
  'signin.unknown.fix': 'Check the number, or contact the ReHarvest team to be added.',
  'signin.code': 'Sign-in code',
  'signin.codeHint': 'We sent a 6-digit code to {phone}. It is valid for 10 minutes.',
  'signin.verify': 'Confirm code',
  'signin.changeNumber': 'Change number',
  'signin.badCode': 'That code is not valid, or it has expired.',
  'signin.badPhone': 'That number does not look right.',
  'signin.rateLimited': 'Too many codes requested. Wait a while and try again.',
  'signin.retry': 'Request a new code and try again.',

  'err.offline': 'No network connection right now.',
  'err.load': 'Could not load your data.',
  'err.retry': 'Try again',
  'err.noLot': 'Pick a lot from the list first.',
  'err.noOrder': 'No open order right now.',
  'ops.alert.FROZEN': 'Frozen lot needs review',
  'ops.alert.WINDOW_CLOSING': 'Collection window closes today',
  'payout.financeManager': 'Finance Manager',

  'weigh.gross': 'Gross weight in kg',
  'weigh.grossHint': 'Read the scale exactly. Do not round.',
  'weigh.containers': 'Number of crates',
  'weigh.containersHint': 'Count the empty crates yourself. Do not trust the delivery note.',
  'weigh.net': 'Net weight',
  'weigh.netIdle': 'Enter the gross weight and the crate count.',
  'weigh.netOk': 'This is the figure the supplier and the buyer are settled on.',
  'weigh.cannotRead': 'No reading can be accepted',
  'weigh.tare': 'Empty crate weight',
  'weigh.expected': 'Expected weight',
  'weigh.difference': 'Difference',
  'weigh.lineTotal': 'Value received',
  'weigh.cta': 'Record weight and accept',
  'weigh.recordedCta': 'Recorded ✓',
  'weigh.recordedPill': 'Accepted',
  'weigh.calibration': 'Scale {id} · calibration valid to {d}',
  'weigh.noScale': 'No approved scale is bound to this session.',
  'weigh.short.msg': 'Received weight is more than 5% below the order.',
  'weigh.short.fix': 'Photograph the load on the scale and tell the buyer before accepting. Billing follows this figure, not the ordered one.',
  'block.QTY_UNVERIFIED_SETTLEMENT_WEIGHT': 'This weight did not come from an approved scale.',
  'block.QTY_UNVERIFIED_SETTLEMENT_WEIGHT.fix': 'Use the station’s approved scale. An estimated or declared weight cannot settle money.',
  'block.QTY_SCALE_CALIBRATION_EXPIRED': 'The scale’s calibration has expired.',
  'block.QTY_SCALE_CALIBRATION_EXPIRED.fix': 'Recalibrate before accepting. A scale drifting 2% is 16 kg wrong on every 800 kg.',
};
