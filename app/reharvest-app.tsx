  ...
  return <main className="app-shell">
    ...
    <section className="workspace" id="top">
      ...
      <div className="content">
        <section className="welcome-row"><div><span className="eyebrow">Monday · 10 August 2026</span><h1>Good evening, Omar.</h1><p>The tomato corridor has one decision waiting before tomorrow’s collection.</p></div><div className="weather-note"><span>34°</span><div><strong>Warm route</strong><small>Plan an early pickup</small></div></div></section>
